...
Begge de punkter, der krævede ejerens input, er lukket 2026-08-08: CR-002 af M0a (`DROP_Q1_RUNTIME`) og CR-005 af P1-scopevalget.
...
| CR-002 | BLOCKER | Q1-lanen er et andet XR-backend, ikke en pakkeversion; Oculus-provider er deprecated | ACCEPT_WITH_MODIFICATION | Fundet accepteres. Lanen blev gjort afhængig af ét fysisk eksperiment (ADR-019). Eksperimentet er kørt 2026-08-08: Q1 crasher på OpenXR, lanen droppet. | Ja — leveret: `prototype/m0a-openxr-smoke/RESULTAT.md` | `docs/06`, `docs/08`, `docs/14`, `docs/18`, `docs/30` | ADR-019 | **Lukket 2026-08-08** — `DROP_Q1_RUNTIME` |
