...
- Review state: **alle 10 review-fund lukket.** CR-002 lukket 2026-08-08 (M0a on-device → DROP_Q1_RUNTIME); CR-005 lukket samme dag (P1-scope valgt: gaveversion = 1.012 t)
...
3. ~~Vælg P1-scope (Q-004)~~ — **gjort 08-08**: alle 55 P1-items sat til `In`/`Defer`; gaveversion = 1.012 t.
