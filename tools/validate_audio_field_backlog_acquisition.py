#!/usr/bin/env python3
"""Fail closed if reacquired field-backlog audio bytes drift from the pinned receipt."""
...
def main() -> int:
    ...
    print(f"Field-backlog acquisition integrity OK: {len(expected)} pinned original(s).")
    return 0
