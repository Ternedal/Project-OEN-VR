...
| B1 jungle/ravine/ridge | readability/reference + ravine prop SVG | `OWN` | Produced source reference; runtime world pending | `source_art/environment/b1/PROVENANCE.md` |
| B1 resource items | item/bundle SVG source | `OWN` | Wood/fiber/herb/food/supplies source produced | `source_art/items/b1/PROVENANCE.md` |
...
- remaining world props/items such as signal fuel, cloth, map fragment and radio battery
