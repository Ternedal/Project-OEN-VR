...
- impact/dust
- wetness reference
- storm phase reference
- rope strain/fiber world cue (`VFX_ROPE_STRAIN_001.svg`)

The rope-strain source is a secondary world cue only; rope shape/state and audio remain the primary feedback channels.

Claude owns runtime VFX, shaders, particle systems, thresholds/timing and Quest 2 performance validation.
