...
- `VFX_RAIN_001.svg` — directional streak source atlas
- `VFX_WIND_DEBRIS_001.svg` — leaf/fiber/twig/debris silhouettes
- `VFX_FIRE_EMBERS_001.svg` — ember source shapes
- `VFX_FIRE_SMOKE_001.svg` — smoke source shapes
- `VFX_IMPACT_001.svg` — dust/fiber impact shapes
