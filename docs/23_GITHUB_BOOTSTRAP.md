...
- **Visibility:** Private
- **Default branch:** `main`
- **Beskrivelse:** `Two-player scenario-based VR survival game for Meta Quest 2, with Quest 3 enhancements.`
...
**Titel:** `M0: Bevis engine-baseline og faelles Quest 2/3 platformlane`

**Definition of done:**

1. Engine-baseline-gaten (ADR-020) er bestået, og minimal build starter på Quest 2 og Quest 3.
